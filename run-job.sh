...
module --ignore_cache load rstudio_kcl/v2022.07.1_554-gcc-9.4.0-r4.1.1-python-3.8.12
...
srun python main.py --model $modelType --outerLR $outerLR --innerLR $innerLR --outputLR $outputLR --steps $steps --batchSize 16 --warmupSteps 100 --kShot 8 --kValShot 8 --numTasks 200000 --lengthTasks $lengthTasks